		...
		<div class="box clear">
            ...
            <div class="box-content">
                <div class="head">
                    <h2>用户列表</h2>
                    <ul class="filter">
						<li><form action="/manage/user/index.php" method="get">用户名：<input type="text" name="uname" class="h-input" value="<?php echo htmlspecialchars($uname); ?>" >&nbsp;邮件：<input type="text" name="like" class="h-input" value="<?php echo htmlspecialchars($like); ?>" >&nbsp;<select name="ucity" style="width:120px;"><?php echo Utility::Option(option_category('city'), $ucity, '所有城市'); ?></select>&nbsp;<input type="submit" value="筛选" class="formbutton"  style="padding:1px 6px;"/><form></li>
					</ul>
				</div>
                <div class="sect">
					<table id="orders-list" cellspacing="0" cellpadding="0" border="0" class="coupons-table">
					<tr><th width="50">ID</th><th width="200">Email/用户名</th><th width="100" nowrap>姓名/城市</th><th width="40">余额</th><th width="40">邮编</th><th width="120">注册IP/注册时间</th></th><th width="100">联系电话</th><th width="120">操作</th></tr>
