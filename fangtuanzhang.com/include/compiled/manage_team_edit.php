        ...
        <div class="clear box">
            ...
            <div class="box-content">
				...
				<form id="-user-form" method="post" action="/manage/team/edit.php?id=<?php echo $team['id']; ?>" enctype="multipart/form-data" class="validator">
					...
					<div class="field">
						<label>特别提示</label>
						<div style="float:left;"><textarea cols="45" rows="5" name="notice" id="team-create-notice" class="f-textarea editor" style="width:710px;height:150px;"><?php echo $team['notice']; ?></textarea></div>
					...
					<div class="field">
						<label>FLV视频短片</label>
						<input type="file" size="30" name="flv" id="team-create-flv" class="f-input" />
						<?php if($team['flv']){?><span class="hint"><?php echo team_image($team['flv']); ?></span><?php }?>
					</div>
					<div class="field">
						<label>本单详情</label>
