...
<div id="content">
        ...
        <div id="deal-buy-login">
            <h3>已有<?php echo $INI['system']['abbreviation']; ?>账户？<?php if(($INI['sms']['login']=='1')){?>手机号可登陆！<?php }?></h3>
            ...
            <div class="sect">
                <form action="/account/signup.php" method="post" id="deal-buy-form-signup" class="validator">
                    <div class="field email">
                        ...
                        <input type="text" class="f-input" size="30" name="email" id="signup-email-address" require="true" datatype="email|ajax" msg="|" url="<?php echo WEB_ROOT; ?>/ajax/validator.php" vname="signupemail" />
                        <span class="hint">登录及找回密码用，不会公开</span>
                    </div>
                    <div class="field username">
                        <label for="signup-username">用户名</label>
                        <input type="text" class="f-input" size="30" name="username" id="signup-username" require="true" datatype="limit|ajax" min="2" max="16" vname="signupname" url="<?php echo WEB_ROOT; ?>/ajax/validator.php" msg="|" maxLength="16" /><span class="hint">4-16 个字符，一个汉字为两个字符</span>
					...
					<?php if(($INI['sms']['reg']=='1')){?>
					<div class="field">
							<label for="signup-password-confirm">手机号码</label>
							<input type="text" size="30" name="mobile" id="signup-mobile" class="number" require="true" datatype="mobile" value="<?php echo $_POST['mobile']; ?>" /><span class="inputtip">手机号码获取短信验证码</span>
						</div>
						<div class="field">
							<label for="signup-verifycode">短信验证码</label>
							<input type="text" size="30" name="verifycode" id="signup-verifycode" class="number" require="true" datatype="require" maxLength="6" value="<?php echo $_POST['verifycode']; ?>" /><span class="inputtip"><a href="javascript:;" onclick="getverifycode1();"><font color="red"><b>获取</b></font></a>&nbsp;&nbsp;&nbsp;&nbsp;验证码请点击“获取”</span>
						</div>
