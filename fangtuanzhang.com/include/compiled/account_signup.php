                ...
                <div class="sect">
                    <form id="signup-user-form" method="post" action="/account/signup.php" class="validator">
						...
						<div class="field">
							...
							<input type="text" size="30" name="mobile" id="signup-mobile" class="number" require="true" datatype="mobile" /><span class="inputtip">手机号码是我们联系您的最重要方式，并用于<?php echo $INI['system']['couponname']; ?>的短信通知</span>
						</div>
						<div class="field">
							<label for="signup-verifycode">短信验证码</label>
							<input type="text" size="30" name="verifycode" id="signup-verifycode" class="number" require="true" datatype="require" maxLength="6" value="<?php echo $_POST['verifycode']; ?>" /><span class="inputtip"><a href="javascript:;" onclick="getverifycode1();"><font color="red"><b>获取</b></font></a>&nbsp;&nbsp;&nbsp;&nbsp;点击“获取”链接  稍后请将您手机接收到的短信验证码输入框中</span>
						</div>
        ...
        <div class="sbox">
            ...
            <div class="sbox-content">
                <div class="side-tip">
				  ...
				  <h2>新浪微博账号登录<?php echo $INI['system']['abbreviation']; ?>！</h2>
