...
<div class="mapbody map"><img src="http://ditu.google.cn/maps/api/staticmap?zoom=12&size=194x194&maptype=roadmap&mobile=true&markers=<?php echo $partner['longlat']; ?>&sensor=false&language=zh_CN" /><a class="link" href="javascript:;" onclick="X.misc.showgooglemap();" title="点击查看完整地图">查看完整地图</a></div>
<?php }?>
