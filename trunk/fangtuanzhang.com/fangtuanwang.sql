...
--
-- Host: localhost
-- Generation Time: Nov 01, 2011 at 01:44 AM
...
CREATE TABLE IF NOT EXISTS `logger_admin` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='管理员操作日志' AUTO_INCREMENT=13 ;
...
(1, 'yfcms@qq.com', 'yfcms', NULL, NULL, 'e14f6842a640f4a8a480dee1c348dbf4', NULL, 'M', 'N', '13468671160', NULL, 0.00, 0, NULL, NULL, 0, 'Y', 'Y', 'Y', '', NULL, NULL, '127.0.0.1', 1319096928, 1319096928, NULL);
