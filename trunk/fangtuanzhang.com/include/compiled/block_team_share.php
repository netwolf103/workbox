...
<div id="deal-share">
	<div class="deal-share-top">
		<div class="deal-share-links">
			<h4>分享到：</h4>
			<ul class="cf"><li><a class="im" href="javascript:void(0);" id="deal-share-im-line" onclick="jQuery('.deal-share-<?php echo $team['id']; ?>').toggle();">MSN/QQ</a></li><li><a class="kaixin" href="<?php echo share_kaixin($team); ?>" target="_blank">开心</a></li><li><a class="renren" href="<?php echo share_renren($team); ?>" target="_blank">人人</a></li><li><a class="douban" href="<?php echo share_douban($team); ?>" target="_blank">豆瓣</a></li><li><a class="sina" href="<?php echo share_sina($team); ?>" target="_blank">新浪微博</a></li><li><a class="email" href="<?php echo share_mail($team); ?>" id="deal-buy-mailto">邮件</a></li></ul>
		</div>
	</div>
	<div class="deal-share-fix"></div>
	<div id="deal-share-im-c" class="deal-share-<?php echo $team['id']; ?>">
