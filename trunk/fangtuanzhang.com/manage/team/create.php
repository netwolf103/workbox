...
if ($_POST) {
	...
	$insert = array(
		...
		'product', 'image', 'detail', 'userreview', 'systemreview', 'image1', 'image2', 'flv', 'card', 'bonus', 'pre_number', 'now_number',
		'mobile', 'address', 'fare', 'express', 'delivery', 'credit',
		'user_id', 'state', 'city_id', 'group_id', 'partner_id',
		'team_type', 'sort_order', 'farefree',
		);
	...
	$team['now_number'] = abs(intval($team['pre_number']));
